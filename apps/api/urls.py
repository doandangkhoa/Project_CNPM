...
urlpatterns = [
    ...
    # nhan khau
    path('nhan-khau/them-moi/', nhan_khau_views.them_moi_nhan_khau, name='the-moi-nhan-khau'),
    path('nhan-khau/cap-nhat', nhan_khau_views.cap_nhat_nhan_khau, name='cap-nhat-nhan-khau'),
