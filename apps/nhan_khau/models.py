...
class NhanKhau(models.Model):
    ho_gia_dinh = models.ForeignKey('ho_gia_dinh.HoGiaDinh', on_delete=models.CASCADE, related_name="nhan_khau")
    ...
    trang_thai = models.CharField(
        max_length=20,
        choices=[("song", "còn sống"), ("chet", "đã chết"), ("chuyen_di", "Đã chuyển đi"),
        ],
        default="song",
    ) 
